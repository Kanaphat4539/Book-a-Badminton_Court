        ...
        <div className="max-w-5xl mx-auto space-y-6 w-full px-4 md:px-margin-screen mt-4 relative z-10">
          <div className="flex justify-between items-center bg-surface-container-low p-6 rounded-3xl shadow-sm transition-colors duration-300">
            ...
            <div className="flex gap-2">
              <button
                className="bg-error hover:opacity-90 text-on-error px-5 py-2.5 rounded-xl font-label-lg text-[15px] transition-all shadow-sm active:scale-95"
    ...
    <MainLayout>
      <div className="flex flex-col w-full pb-10">
        ...
        <div className="px-4 md:px-margin-screen flex flex-col gap-6 mt-3">
          ...
          {/* Visual Stadium Highlight Banner */}
          <section className="relative rounded-2xl overflow-hidden shadow-sm h-32 flex items-end p-4">
            <img 
              alt="KMITL Badminton Court Stadium" 
              className="absolute inset-0 w-full h-full object-cover object-center" 
              src="https://lh3.googleusercontent.com/aida-public/AB6AXuCrwVxirU7mS5fPGAPa8KGBv04tePk-rsPVdZfHf8LX3dnx3ru-A3U5y5CGVhg4tt5nXqHBufXLyLpvSmhabNMR0JmyLrn0bfDmZf1lJqR7mEPUPajgOOwOn4Bf7ILlu2MJd1GfqF0ioS2dXOGtotc0MCo_-rf10MSzcM0uppNdV6gScWdz_ulP66KLw2dYXxa128V0mslvs2C1rrhde9Edi1IV2PeJ55IjksmSS35KGPdoqTCTzpUAnXZKgXj3VDcJ2g"
            />
            ...
            <div className="relative z-10 flex items-center justify-between w-full">
              <div className="flex flex-col text-on-primary">
                <span className="font-label-sm text-label-sm uppercase tracking-widest text-primary-fixed font-bold">Gymnasium Hall 1</span>
                <span className="font-headline-sm text-headline-sm font-bold text-on-primary">6 Courts Available</span>
              </div>
              <div className="flex items-center gap-1 bg-surface-container-lowest/90 backdrop-blur-md px-2.5 py-1 rounded-full text-on-surface shadow-sm">
                <span className="w-2 h-2 rounded-full bg-secondary"></span>
                <span className="font-label-sm text-label-sm font-bold">Open 08:00 - 22:00</span>
              </div>
            </div>
          </section>
